...
<h5 class="mb-4 text-secondary">
    <a class="text-dark" href="css-js-files">CSS & JS Files</a> > <?php echo $file->name . "." . $file->type ?>
</h5>
...
<div class="d-flex flex-column">
    ...
    <div class="page-actions d-flex justify-content-between">
        <div class="btn-group">
            <a href="<?php echo $file_path ?>" target="_blank" class="btn btn-dark"><i class="fas fa-external-link-alt"></i> View</a>
            <a href="<?php echo $file_path ?>" download data-toggle="tooltip" title="Download" class="btn btn-light active"><i class="fas fa-download"></i></a>
        </div>
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu">
                <form action="" method="POST">
                    ...
                    <input type="hidden" name="file_author" value="<?php echo $file->author ?>">
                    <button type="submit" name="remove_file_submit" class="btn btn-link text-danger dropdown-item" onClick="return confirm('Delete this file?')">Delete File</button>
                </form>
            </div>
        </div>
    </div>
