<style>
    h1 { font-size: 50px; }
    div.maintenance { display: block; text-align: left; width: 650px; margin: 0 auto; }
    a { color: #dc8100; text-decoration: none; }
    a:hover { color: #333; text-decoration: none; }
</style>

<div class="container maintenance h-100 w-100 d-flex justify-content-center flex-column mw-60">
